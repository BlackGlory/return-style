export function returnResultGenerator<Yield, Return, Next, Args extends unknown[] = any[]>(fn: (...args: Args) => Generator<Yield, Return, Next>): (...args: Args) => Generator<Yield, Return | null, Next> {
