...
export function returnErrorResultFromFunction<Error, Result, Args extends unknown[] = any[]>(fn: (...args: Args) => Result | PromiseLike<Result>): (...args: Args) => ([Error, null] | [null, Result]) | Promise<[Error, null] | [null, Result]> // for returnErrorResultFromConstructor
